...
public interface OrderDetailsRepository extends JpaRepository<OrderDetails, Integer>{
	...
	@Query(value="Select * from OrderDetails where Customer_Id = ?1 and Order_Date between last_day(add_months(TO_DATE(?3,'YYYY-MM-DD'),?2)) and TO_DATE(?3,'YYYY-MM-DD') ", nativeQuery = true)
